...
function Shop() {
 ...
 "name":'name'
          ...
          await axios.post("http://103.104.74.215:3008/website/subcategory_list",data,options).then(res => {
                  ...
                  <div className="tab_content">
                    <div id="product_grid" className="tab_pane active show">
                      <div className="product__section--inner product__grid--inner">
                        ...
                        {lists.map((list) => {
                        return(
                          <div className="col mb-30" onClick={(()=>localStorage.setItem("sub_id",list._id))}> 
                          
                          
                            <div className="product__items ">
                              <div className="product__items--thumbnail">
                                <Link className="product__items--link" to="/shop1">

                                 <img style={{height:'167px'}} className="product__items--img product__primary--img" src={"http://103.104.74.215:3008/uploads/"+list.image}  alt="product-img" />
                              ...
                              <div className="product__items--content text-center">
                                ...
                                <h3 className="product__items--content__title h4"><a href="product-details.html">{list.name}</a></h3>
