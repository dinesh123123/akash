  ...
  const getHomeData = async () => {
    const options ={
       ...
       const data = JSON.stringify({
        ...
        await axios.get("http://103.104.74.215:3008/website/privacy_pollicy_list",data,options).then(res => {
            ...
            <div className="row row-cols-1">
              <div className="col">
                <div className="breadcrumb__content">
                  <h1 className="breadcrumb__content--title text-white mb-10">Privacy Policy</h1>
