   ...
   const getHomeData = async () => {
     const options ={
        ...
        const data = JSON.stringify({
         ...
         await axios.get("http://103.104.74.215:3008/website/contact_us_list",data,options).then(res => {
                                ...
                                <div class="contact__info--items">
                                    ...
                                    <div class="contact__info--items__inner d-flex">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact__info--content__desc text-white">Change the design through a range <br/> <a href="tel:+01234-567890">{list.whatsapp}</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="contact__info--items">
                                    ...
                                    <div class="contact__info--items__inner d-flex">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact__info--content__desc text-white"> <a href="rentifi@gmail.com">{list.email_address}</a> <br/> </p> 
                                        </div>
                                    </div>
                                </div>
                                <div className="contact__info--items__inner d-flex"><div className="contact__info--icon"> <img style={{height:'30px' , width:'26px'}} src='assets/img/logo/download2.jpg'/></div><div className="contact__info--content"><p className="contact__info--content__desc text-white"> <a
        href="https://wa.me/673486897293"
        class="whatsapp_float"
        target="_blank"
        rel="noopener noreferrer"
      >
        <i class="fa fa-whatsapp whatsapp-icon"></i>
        Contact Us On whatsapp-({list.whatsapp})
      </a>
       <br /> </p></div></div>
                                <div class="contact__info--items">
